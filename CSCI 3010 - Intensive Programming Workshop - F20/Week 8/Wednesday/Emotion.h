...
// Go ahead and make up answers for the other traits.
    ...
    static Emotion * GetHappy() {return new Emotion("Happy", true, false, 1,1,1);}    
...
// and is not (readily/easily) communicable. Use what you know and your imagination to fill in the other fields.
    static Emotion * GetAngry() {return new Emotion("Angry", false, false, 0.3,0.7,0.7);}    
...
// can be something that you've made up).
    static Emotion * GetJoy() {return new Emotion("Joy", true, false, 0.8, 0.8, 0.8);}
