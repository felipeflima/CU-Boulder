...
QT_MOC_LITERAL(1, 11, 15), // "ChangeColorTurn"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 5), // "Cell*"
QT_MOC_LITERAL(4, 34, 1) // "c"

    },
    "GameOfLife\0ChangeColorTurn\0\0Cell*\0c"
};
...
void GameOfLife::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ChangeColorTurn((*reinterpret_cast< Cell*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (GameOfLife::*)(Cell * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameOfLife::ChangeColorTurn)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameOfLife::ChangeColorTurn(Cell * _t1)
{
