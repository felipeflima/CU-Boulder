...
QT_MOC_LITERAL(1, 5, 12), // "CellSelected"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 5), // "Cell*"
QT_MOC_LITERAL(4, 25, 1), // "c"
QT_MOC_LITERAL(5, 27, 16) // "CellRightClicked"

    },
    "Cell\0CellSelected\0\0Cell*\0c\0CellRightClicked"
};
...
void Cell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->CellSelected((*reinterpret_cast< Cell*(*)>(_a[1]))); break;
        case 1: _t->CellRightClicked((*reinterpret_cast< Cell*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cell::CellSelected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Cell::*)(Cell * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cell::CellRightClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Cell::CellSelected(Cell * _t1)
{
...
// SIGNAL 1
void Cell::CellRightClicked(Cell * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
