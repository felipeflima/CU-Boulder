...
#include "../Game/MemoryGame/cards.h"
...
QT_MOC_LITERAL(1, 6, 12), // "CardSelected"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 6), // "Cards*"
QT_MOC_LITERAL(4, 27, 1) // "c"

    },
    "Cards\0CardSelected\0\0Cards*\0c"
};
...
void Cards::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->CardSelected((*reinterpret_cast< Cards*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Cards::*)(Cards * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Cards::CardSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Cards::CardSelected(Cards * _t1)
{
