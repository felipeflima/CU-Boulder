...
#include "../Game/MemoryGame/board.h"
...
QT_MOC_LITERAL(3, 13, 12), // "updatePoints"
QT_MOC_LITERAL(4, 26, 12) // "updatePlayer"

    },
    "Board\0reset\0\0updatePoints\0updatePlayer"
};
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->updatePoints(); break;
        case 2: _t->updatePlayer(); break;
        default: ;
        }
        ...
        {
            using _t = void (Board::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Board::reset)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Board::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Board::updatePoints)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Board::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Board::updatePlayer)) {
                *result = 2;
                return;
            }
        }
